...
class Obj32 : public adf::graph { public:
  ...
  ObjAttnGraphL<0,24> i24;
  ObjAttnGraphL<0,25> i25;
  ObjAttnGraphL<0,26> i26;
  ObjAttnGraphL<0,27> i27;
  ObjAttnGraphL<0,28> i28;
  ObjAttnGraphL<0,29> i29;
  ObjAttnGraphL<0,30> i30;
  ObjAttnGraphL<0,31> i31;
};
Obj32 aie_graph;
